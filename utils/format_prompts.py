...
file_path = r'D:\AI-Software\configs\wildcards\style\4thTail_best.txt'
process_file(file_path, similarity_threshold=100, sort=True, add_empty_lines=False, apply_mixed_case_conversion=False)