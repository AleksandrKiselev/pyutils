...
file_path = r'D:\AI-Software\configs\wildcards\nsfw\nsfw.txt'
process_file(file_path, similarity_threshold=95, sort=False, add_empty_lines=False, apply_mixed_case_conversion=False)